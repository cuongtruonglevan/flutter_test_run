...
class StatsScreen extends StatelessWidget {
  ...
  Widget _buildResultChart(BuildContext context) {
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildResultCard(_result, _isFirst);
        },
      ),
    );
  }
        ...
        child: PopupMenuButton(
          ...
          onSelected: (int value) {
            if (value != null) {
              ...
              if (value == 2) _selectedValue.value = 'Blood Pressure';
            }
            return;
          },
        ),
  ...
  Widget _buildResultCard(int result, bool isFirst) {
    return Container(
              ...
              Expanded(
                child: LayoutBuilder(
                  builder: (context, constraint) {
                    final _leftMargin =
                        constraint.maxWidth * ((result - 100) / 80);
                    return Stack(
                      children: [
                        Container(
